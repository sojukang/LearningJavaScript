...
// orderSetMenu function for learning optional parameters
function orderSetMenu(sandwichName, drinkName = '스프라이트') {
    console.log(`주문하신 ${sandwichName}, ${drinkName} 세트메뉴 나왔습니다!`);
};
